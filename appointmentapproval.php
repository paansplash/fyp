...
if (isset($_POST['submit'])) {
	if (isset($_GET['editid'])) {
		...
		$sql = "INSERT INTO appointment(patientid,roomid,departmentid,appointmentdate,appointmenttime,doctorid,status) values('$_POST[select4]','$_POST[select3]','$_POST[select5]','$_POST[appointmentdate]','$_POST[time]','$_POST[select6]','$_POST[select]')";
		if ($qsql = mysqli_query($con, $sql)) {
...
<div class="container">
	...
	<br>
	<p>Appointment record Approval Process</p>
