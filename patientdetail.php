...
if (isset($_POST['submitpat'])) {
	$sql = "INSERT INTO patient(patientname,address,mobileno,gender,dob) values('$_POST[patientname]','$_POST[address]','$_POST[mobilenumber]','$_POST[select]','$_POST[dateofbirth]')";
