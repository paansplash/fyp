...
if (isset($_POST['submitapp'])) {
	$sql = "INSERT INTO appointment(departmentid,appointmentdate,appointmenttime,doctorid) values('$_POST[select3]','$_POST[date]','$_POST[time]','$_POST[select5]')";
...
<script type="application/javascript">
	function validateform() {
		if (document.frmappntdetail.select3.value == "") {
