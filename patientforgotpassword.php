...
if (isset($_POST['submit'])) {
	...
	if (mysqli_num_rows($qsql) >= 1) {
		...
		$msg = "Kindly enter Username: $rslogin[loginid] and Password is : $rslogin[password] to login Healthcare system..";
?>
...
<div class="container">
	...
	<br>
	<p>Kindly enter login detail to recover password..</p>
