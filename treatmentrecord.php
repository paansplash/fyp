						...
						<select name="select4" id="select4">
							...
							while ($rstreatment = mysqli_fetch_array($qsqltreatment)) {
								if ($rstreatment['treatmentid'] == $rsedit['treatmentid']) {
									echo "<option value='$rstreatment[treatmentid]' selected>$rstreatment[treatmenttype]  - (RM $rstreatment[treatment_cost])</option>";
								} else {
									echo "<option value='$rstreatment[treatmentid]'>$rstreatment[treatmenttype]  - (RM $rstreatment[treatment_cost])</option>";
								}
							}
							?>
						</select>
